...
class AlertDialogNotDrugInListWidget extends StatefulWidget {
  const AlertDialogNotDrugInListWidget({super.key});

  @override
  State<AlertDialogNotDrugInListWidget> createState() =>
      _AlertDialogNotDrugInListWidgetState();
}

class _AlertDialogNotDrugInListWidgetState
    extends State<AlertDialogNotDrugInListWidget>
                    ...
                    Container(
                      ...
                      child: Stack(
                        children: [
                          ...
                          Align(
                            alignment: AlignmentDirectional(1.52, 1.34),
                            child: ClipRRect(
